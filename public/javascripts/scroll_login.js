define(['N','domEvent_login'],function(N,domEvent_login){
    ...
    return {
        ...
        "Tumblr_start_0": function(){
            ...
            domEvent_login.loginButtonReset && domEvent_login.loginButtonReset();
            domEvent_login.lButton && (domEvent_login.lButton.style.color = "#56bc8a",domEvent_login.lButton.style.background = "#fff");
        ...
        "Tumblr_end_0": function(){
            ...
            domEvent_login.loginButtonHide && domEvent_login.loginButtonHide();
            domEvent_login.lButton && (domEvent_login.lButton.removeAttribute('style'));
