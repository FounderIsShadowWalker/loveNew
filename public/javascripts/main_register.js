...
require(['fullPage','scroll_register','domEvent_register'],function(fullPage,scroll_register,domEvent_register){
    //var A = "A"
    //fullPage(function(test){console.log("下滑了");console.log(test);console.log(A)}, function(){console.log("上滑了")});

    var extendScroll = fullPage(scroll_register);

    domEvent_register.top = extendScroll.top;
